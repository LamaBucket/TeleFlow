...
public class StepCommandFactoryBuilder
{
    ...
    public StepCommandFactoryBuilder AddTextInput(string userPrompt, Func<IServiceProvider, string, Task> onUserInput) => Add(() => new TextInputStep(userPrompt, onUserInput));
