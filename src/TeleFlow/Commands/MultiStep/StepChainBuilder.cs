...
namespace TeleFlow.Commands.MultiStep;

public class StepChainBuilder
{
    public event Func<Task>? ChainFinished;

    public Stack<IHandlerFactoryWithContext<StepCommand, Update, StepCommand>> StepFactoryChain => new(_stepFactoryChain);

    public StepCommand? Head => _head;


    private readonly Stack<IHandlerFactoryWithContext<StepCommand, Update, StepCommand>> _stepFactoryChain;
    
    private StepCommand? _head;


    public void AddItemToChain(IHandlerFactoryWithContext<StepCommand, Update, StepCommand> factory)
    {
    ...
    private Stack<IHandlerFactoryWithContext<StepCommand, Update, StepCommand>> CreateStepFactoryChainForNSteps(int n)
    {
        Stack<IHandlerFactoryWithContext<StepCommand, Update, StepCommand>> stack = new();
    ...
    public StepCommand BuildChain(IHandlerFactoryWithContext<StepCommand, Update, StepCommand> factory, bool overwrite = false)
    {
        ...
        var stack = new Stack<IHandlerFactoryWithContext<StepCommand, Update, StepCommand>>();
        stack.Push(factory);
    ...
    private StepCommand BuildChain(Stack<IHandlerFactoryWithContext<StepCommand, Update, StepCommand>> stepFactoryChain, bool overwrite = false)
    {
