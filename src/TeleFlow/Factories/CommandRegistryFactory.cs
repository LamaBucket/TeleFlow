...
public class CommandRegistryFactory : ICommandFactory<ICommandHandler, ChatSession>
{
    ...
    public CommandRegistryFactory(ReadOnlyDictionary<string, ICommandFactory<ICommandHandler, ChatSession>> factories)
    {
