...
using TeleFlow.Core.Commands.Stateful.Steps.TextInputCommandStep;

namespace TeleFlow.Core.Commands.Stateful.StepRender.TextInputCommandStep;

public class TextInputRenderService : IStepRenderService<TextInputCommandStepViewModel>
{
    private readonly TextInputRenderServiceOptions _options;

    public InlineMarkupMessage Render(IServiceProvider serviceProvider, TextInputCommandStepViewModel model)
    {
        string message = "";
