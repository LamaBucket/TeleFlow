...
using TeleFlow.Core.Commands.Stateful.StepRender.FileInputCommandStep;
using TeleFlow.Core.Commands.Stateful.Steps.ContactInputCommandStep;
using TeleFlow.Core.Commands.Stateful.Steps.FileInputCommandStep;

namespace TeleFlow.Core.Commands.Stateful.StepRender.ContactInputCommandStep;

public class ContactInputRenderService : IStepRenderService<ContactInputStepViewModel>
{
